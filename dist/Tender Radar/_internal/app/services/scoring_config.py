...
# =========================================
# 📦 SEPARATE NICHT-AKTIVE / BEREITS VERGEBENE MARKER
# Diese markieren fachlich evtl. interessante Fälle,
# die aber nicht mehr aktiv bewerbbar sind.
# =========================================

NON_ACTIONABLE_STATUS = [
    "vergebener auftrag",
    "vergabebekanntmachung",
    "bekanntmachung vergebener auftraege",
